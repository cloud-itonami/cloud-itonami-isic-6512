...
(def default-corporate-intel-screen
  ...
  in `casualty.corporate-intel/screen` (or an equivalent). Not required
...
(defn- screen-kyc
  ...
  `casualty.corporate-intel/screen`) is consulted ONLY once the local
...
(defn mock-advisor
  ...
  opts:
    :corporate-intel-screen -- party name -> corporate-intel result (see
      `casualty.corporate-intel/screen`). Default: no-op (never changes a
